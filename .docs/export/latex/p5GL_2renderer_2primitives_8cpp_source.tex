...
\hypertarget{p5GL_2renderer_2primitives_8cpp_source}{}\label{p5GL_2renderer_2primitives_8cpp_source}\index{/home/admin/github/p5GL/renderer/primitives.cpp@{/home/admin/github/p5GL/renderer/primitives.cpp}}
...
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classVector3}{Vector3}}\ \mbox{\hyperlink{namespacecenter}{center}}\ =\ \mbox{\hyperlink{classVector3}{Vector3}}((bottomLeft.x\ +\ topRight.x)\ /\ 2,\ (bottomLeft.y\ +\ topRight.y)\ /\ 2,\ 0);}
\DoxyCodeLine{00044\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00045\ \ \ \ \ \ \ \ \ \textcolor{keyword}{auto}\ rotatePoint\ =\ [cosAngle,\ sinAngle,\ \mbox{\hyperlink{namespacecenter}{center}}](\mbox{\hyperlink{classVector3}{Vector3}}\ point)\ \{}
\DoxyCodeLine{00046\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ x\ =\ point.x\ -\/\ \mbox{\hyperlink{namespacecenter}{center}}.x;}
\DoxyCodeLine{00047\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ y\ =\ point.y\ -\/\ \mbox{\hyperlink{namespacecenter}{center}}.y;}
\DoxyCodeLine{00048\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ newX\ =\ x\ *\ cosAngle\ -\/\ y\ *\ sinAngle\ +\ \mbox{\hyperlink{namespacecenter}{center}}.x;}
\DoxyCodeLine{00049\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ newY\ =\ x\ *\ sinAngle\ +\ y\ *\ cosAngle\ +\ \mbox{\hyperlink{namespacecenter}{center}}.y;}
...
\DoxyCodeLine{00058\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classVector3}{Vector3}}\ \mbox{\hyperlink{namespacecenter}{center}}\ =\ \mbox{\hyperlink{classVector3}{Vector3}}((bottomLeft.x\ +\ topRight.x)\ /\ 2,\ (bottomLeft.y\ +\ topRight.y)\ /\ 2,\ 0);}
\DoxyCodeLine{00059\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00060\ \ \ \ \ \ \ \ \ bottomLeft\ =\ (bottomLeft\ -\/\ \mbox{\hyperlink{namespacecenter}{center}})\ *\ scaleFactor\ +\ \mbox{\hyperlink{namespacecenter}{center}};}
\DoxyCodeLine{00061\ \ \ \ \ \ \ \ \ topRight\ =\ (topRight\ -\/\ \mbox{\hyperlink{namespacecenter}{center}})\ *\ scaleFactor\ +\ \mbox{\hyperlink{namespacecenter}{center}};}
\DoxyCodeLine{00062\ \ \ \ \ \}}
\DoxyCodeLine{00063\ \};}
\DoxyCodeLine{00064\ }
...
\DoxyCodeLine{00078\ \};}
\DoxyCodeLine{00079\ }
\DoxyCodeLine{00080\ \textcolor{keyword}{class\ }\mbox{\hyperlink{structPoint}{Point}}\ }
\DoxyCodeLine{00081\ \{}
\DoxyCodeLine{00082\ \ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00083\ \ \ \ \ \mbox{\hyperlink{classVector3}{Vector3}}\ pos;}
\DoxyCodeLine{00084\ }
\DoxyCodeLine{00085\ \ \ \ \ \mbox{\hyperlink{structPoint}{Point}}(\mbox{\hyperlink{classVector3}{Vector3}}\ \_pos)}
\DoxyCodeLine{00086\ \ \ \ \ \ \ \ \ :\ pos(\_pos)\ \{\}}
\DoxyCodeLine{00087\ \ \ \ \ \mbox{\hyperlink{structPoint}{Point}}()}
